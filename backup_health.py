...
def retention_policy() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"data": "Спорные пары сопоставления", "table": "matching_pairs",
         "days": database.MATCHING_PAIRS_RETENTION_DAYS,
         "why": "разобранные случаи нужны для проверки качества, дальше их заменяет новый набор"},
        {"data": "Суточные сводки", "table": "daily_reports", "days": database.DAILY_REPORT_RETENTION_DAYS,
         "why": "полгода сводок хватает для сравнения периодов, отчёт всегда можно пересчитать"},
