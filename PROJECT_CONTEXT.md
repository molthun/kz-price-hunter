...
> **Версия системы**: **v4.0.0** (2026-09-18)  
...
В проект интегрирована трехуровневая AI-система (понимание поисковых запросов естественным языком, RAG AI-консультант в Web UI и Telegram, а также каноническая нормализация моделей для 100% точного кросс-магазинного арбитража).
...
1. **Таблица `products`**:
   ...
   - `canonical_key TEXT` — нормализованный ключ модели (`apple:iphone 15:128gb`) для 100% сопоставления
