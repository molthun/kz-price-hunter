...
Статус: IN_PROGRESS — P02-00 (анализ и дизайн) завершён; пороги ниже — ПРЕДЛОЖЕНИЕ, ждут подтверждения владельца
  до реализации (план: «Порог baseline зафиксирован в карточке задачи до реализации»).
...
Следующий шаг: подтверждение порогов Q1–Q4 владельцем, затем P02-01.
```
