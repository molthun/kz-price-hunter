...
| P07 | V1 DEPLOYED (v5.11.0); V2 REVIEW (M10 исправлен) | Claude | Codex: G01/G02 закрыты (V1); M10 на повторной приёмке | v5.11.0 на shop.molthun.ru с 18:26 (проверка чтением /api/version, /api/stats, /api/deals, /monitoring) |
...
| P09 | DEPLOYED (v5.11.0); AI-часть REVIEW (M11 исправлен) | Claude | Codex: I01/I02 закрыты (правила); M11 на повторной приёмке | v5.11.0 на shop.molthun.ru с 18:26 (проверка чтением /api/version, /api/stats, /api/deals, /monitoring) |
...
| P11 | REVIEW (M01–M03 исправлены) | Claude | Codex: M01–M03 на повторной приёмке | Не выпущен |
| P12 | REVIEW (M04 исправлен) | Claude | Codex: M04 на повторной приёмке | Не выпущен |
| P13 | REVIEW (M04–M06 исправлены) | Claude | Codex: M04–M06 на повторной приёмке | Не выпущен |
...
| P16 | REVIEW (M07–M09 исправлены) | Claude | Codex: M07–M09 на повторной приёмке | Не выпущен |
